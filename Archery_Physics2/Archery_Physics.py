...
flecha_X, flecha_Y = 100, 450
arco_X, arco_Y = 100, 450
pessoa_X, pessoa_Y = 1000, 490
maca_X, maca_Y = 999, 385
...
flecha = Flecha("flecha2.png", flecha_X,flecha_Y)
arco = Arco("arco2.png", arco_X, arco_Y)
pessoa = Pessoa("pessoa2.png", pessoa_X, pessoa_Y)
maca = Maca("maca2.png",maca_X, maca_Y)
